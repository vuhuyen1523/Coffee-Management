                ...
                <div class="hero__search">
                    ...
                    <div class="hero__search__phone">
                        <div class="hero__search__phone__icon">
                            <span class=""><i class="fa fa-phone animate__animated animate__heartBeat animate__infinite"></i></span>
                        </div>
                        <div class="hero__search__phone__text">
                            <h5>+84 35.2820.003</h5>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="blog__item">
                    ...
                    <div class="blog__item__text">
                        <ul>
                            <li><i class="fa fa-calendar-o"></i> December 31,2001</li>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="blog__item">
                    ...
                    <div class="blog__item__text">
                        <ul>
                            <li><i class="fa fa-calendar-o"></i> Aprill 19,2022</li>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="blog__item">
                    ...
                    <div class="blog__item__text">
                        <ul>
                            <li><i class="fa fa-calendar-o"></i> Janury 7,2022</li>
